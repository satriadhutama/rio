"""run_multi_coin_v2_4h.py — Orchestrator backtest v2 untuk timeframe 4H.

Copy logika dari `run_multi_coin_v2.py` dengan perbedaan HANYA:
  - import strategy_trend_v2_4h (yang re-export compute_signals_v2)
  - data path: data/deriv/ohlcv_4h, funding_4h, oi_4h
  - output path: outputs/trades_v2_4h.parquet dll.
...
TRADES_OUT = OUTPUT_DIR / "trades_v2_4h.parquet"
EQUITY_OUT = OUTPUT_DIR / "equity_v2_4h.parquet"
SUMMARY_OUT = OUTPUT_DIR / "summary_v2_4h.parquet"
...
def process_coin(coin: str) -> tuple[pd.DataFrame, pd.DataFrame, dict]:
    ...
    sig = strategy_trend_v2_4h.compute_signals_v2(ind, funding, oi)
