"""run_multi_coin_v2.py — Orchestrator backtest v2 (10 coin, daily).

Loop coin -> compute_all_indicators -> compute_signals_v2 -> run_backtest
-> compute_metrics. Output:
    outputs/trades_v2.parquet
    outputs/equity_v2.parquet
    outputs/summary_v2.parquet
"""
...
TRADES_OUT = OUTPUT_DIR / "trades_v2.parquet"
EQUITY_OUT = OUTPUT_DIR / "equity_v2.parquet"
SUMMARY_OUT = OUTPUT_DIR / "summary_v2.parquet"
...
def process_coin(coin: str) -> tuple[pd.DataFrame, pd.DataFrame, dict]:
    ...
    # Rename time -> date untuk kompatibilitas live_paper_report.
